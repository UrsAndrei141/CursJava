...
public class ConditionalOperator {
	...
	public static void main(String[] args) {
		...
		result = nr1 >0 ? "Nr2 este pozitiv" : "Nr2 este negativ";
		System.out.println(result);
		...
		//verificam care este mai mare sau daca sunt egal
		if(nr1 == nr2) {
		...
		result = (nr1 == nr2) ? "Sunt egale": (nr1>nr2) ? "Nr1 este mai mare" : "Nr 2 este mai mare";
